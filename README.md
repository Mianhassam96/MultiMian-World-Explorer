...
│   ├── page.js                # Home page with country list
│   ├── globals.css            # Global styles
│   ├── countries/[code]/      # Dynamic country detail pages
...
│   ├── ComparisonTool.js      # Country comparison interface
│   ├── WorldMap.js            # Interactive Leaflet map
│   ├── RecentlyViewed.js      # Recently viewed countries
│   ├── SkeletonCard.js        # Loading skeleton
│   └── CountryDetails/        # Country detail tabs
│       ├── CountryTabs.js
│       ├── OverviewTab.js
│       ├── GeographyTab.js
│       ├── CultureTab.js
